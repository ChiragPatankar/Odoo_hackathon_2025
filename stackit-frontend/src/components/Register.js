      ...
      <div className="max-w-md w-full mx-4">
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 p-8 text-center">
            ...
            <h1 className="text-2xl font-bold text-white mb-2">Join StackIt</h1>
            <p className="text-blue-100">Create your developer account</p>
          </div>
          ...
          <div className="p-8">
            ...
            <div className="mt-6 p-4 bg-gradient-to-r from-green-50 to-blue-50 rounded-xl border border-green-100">
              <div className="flex items-start">
                ...
                <div>
                  <p className="text-sm font-semibold text-green-800 mb-1">Free Account Benefits:</p>
                  <ul className="text-xs text-green-700 space-y-1">
                    <li>• Ask unlimited questions</li>
                    <li>• Answer and help others</li>
